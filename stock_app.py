...
rnn_closing_price=rnn_model.predict(X_test)
rnn_closing_price=scaler.inverse_transform(rnn_closing_price)

lstm_closing_price=lstm_model.predict(X_test)
lstm_closing_price=scaler.inverse_transform(lstm_closing_price)


train=new_data[:987]

rnn_valid=new_data[987:]
rnn_valid['Predictions']=rnn_closing_price

lstm_valid=new_data[987:]
lstm_valid['Predictions']=lstm_closing_price
    ...
    dcc.Tabs(id="tabs", children=[
        ...
        dcc.Tab(label='NSE-TATAGLOBAL Stock Data',children=[
			html.Div([
				...
				dcc.Graph(
					id="RNN Predicted Data",
					figure={
						"data":[
							go.Scatter(
								x=rnn_valid.index,
								y=rnn_valid["Predictions"],
								mode='markers'
							)
